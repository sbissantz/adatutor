...
four large-scale replication projects: Many Labs 1 and 3, the
Replication Project Psychology, and the Experimental Economics
Replication Project. The data for the Social Science Replication Project
(SSRP) are missing.
...
A data frame with 131 study effects (i.e., rows); 2 identifiers, and 5
